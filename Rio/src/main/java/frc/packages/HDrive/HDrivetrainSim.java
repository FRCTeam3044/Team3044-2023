...
public class HDrivetrainSim {
   ...
   *                           created with {@link frc.packages.HDrive.HDrivetrainLateralSystemId#createHDrivetrainLateralVelocitySystem(DCMotor, double, double, double, double, double)}
   *                           or {@link frc.packages.HDrive.HDrivetrainLateralSystemId#identifyLateralVelocitySystem(double, double, double, double)}
